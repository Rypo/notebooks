...
# COMPLETE RANDOM FOREST FEATURE IMPORTANCE BEFORE SHIP
# NOTE: DO NOT ATTEMPT TO RUN UNTIL ERROR RESOLVED... RUN TIME LONG:

# Line 259 Error in { : task 1 failed - "argument 1 is not a vector"
# Calls: <Anonymous> ... rfe.default -> nominalRfeWorkflow -> %op% -> <Anonymous>
# Execution halted
```
...
step.pvmodel.fwd <- SignifReg(CARAVAN ~ ., data=cic_data,
                    ...
                    criterion="p-value",correction="FDR", trace = FALSE)
...
```{r}
# Extrememly thin wrapper to be able to see all the possiable config params at a glance
umap.wrap <- 
...
Our initial experimentation with UMAP does not indicate any clearly distigushable difference between the classes. Perhaps with a bit of parameter tweaking we can coerce useful information out of this algorithm.
